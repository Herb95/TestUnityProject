        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaPerfect.ObjectFormater gen_ret = new LuaPerfect.ObjectFormater();
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        bool gen_ret = LuaPerfect.ObjectFormater.IsBasicType( _type );
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        System.Collections.Generic.List<System.Reflection.FieldInfo> gen_ret = LuaPerfect.ObjectFormater.GetAllFields( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = LuaPerfect.ObjectFormater.FindProperty( _allProperties, _name );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        System.Collections.Generic.List<System.Reflection.PropertyInfo> gen_ret = LuaPerfect.ObjectFormater.GetAllProperties( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        string gen_ret = LuaPerfect.ObjectFormater.GetClassFullName( _type );
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        LuaPerfect.ClassInfoItem gen_ret = LuaPerfect.ObjectFormater.GetClassInfo( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GameObject _gameObject = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        System.Collections.Generic.List<UnityEngine.GameObject> gen_ret = LuaPerfect.ObjectFormater.GetChildrenGameObjects( _gameObject );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _collectChildren = LuaAPI.lua_toboolean(L, 2);
                        ...
                        LuaPerfect.ObjectItem gen_ret = LuaPerfect.ObjectFormater.FormatObject( _obj, _collectChildren );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _collectChildren = LuaAPI.lua_toboolean(L, 2);
                        ...
                        LuaPerfect.ObjectItem gen_ret = LuaPerfect.ObjectFormater.InnerFormatObject( _obj, _collectChildren );
                        translator.Push(L, gen_ret);
